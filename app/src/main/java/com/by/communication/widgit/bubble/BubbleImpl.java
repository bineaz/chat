package com.by.communication.widgit.bubble;
...
class BubbleImpl implements BubbleStyle {
    ...
    void init(View view, Context context, AttributeSet attrs)
    {
        ...
        if (attrs != null) {
            ...
            mArrowHeight = ta.getDimension(R.styleable.BubbleStyle_bb_arrowHeight, Util.dip2px(6));
            mArrowWidth = ta.getDimension(R.styleable.BubbleStyle_bb_arrowWidth, Util.dip2px(10));
            ...
            float radius = ta.getDimension(R.styleable.BubbleStyle_bb_cornerRadius, Util.dip2px(4));
            ...
            mFillColor = ta.getColor(R.styleable.BubbleStyle_bb_fillColor, Color.WHITE);
