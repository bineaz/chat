package com.by.communication.widgit.adapter.callback;
...
import com.by.communication.widgit.adapter.BaseItemDraggableAdapter;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        return type == mAdapter.HEADER_VIEW || type == mAdapter.LOADING_VIEW
