package com.by.communication.camera;
...
import com.by.communication.entity.MediaObject.MediaPart;
...
//			cmd += String.format("addcmd = %s; "," -vf \"transpose=1,crop=854:480:0:0\" ");
    ...
    protected void onStartPreviewSuccess()
    {
        ...
        UtilityAdapter.RenderOutputSettings(FFMpegUtils.VIDEO_WIDTH, FFMpegUtils.VIDEO_HEIGHT, mFrameRate, UtilityAdapter.OUTPUTFORMAT_YUV | UtilityAdapter.OUTPUTFORMAT_MASK_MP4 /*| UtilityAdapter.OUTPUTFORMAT_MASK_HARDWARE_ACC*/);
    }
