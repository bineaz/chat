...
public class AnimationBuilder {
     ...
     *
     * @param anim  the view animator
     * @param views the views
     */
    public AnimationBuilder(Anim anim, View... views) {
        this.anim = anim;
        this.views = views;
    }
    ...
    public AnimationBuilder hardWare() {
        for (View view : views) {
    ...
    public AnimationBuilder topMargin(float... margin) {
        return custom(new AnimationListener.Update() {
            @Override
            public void update(View view, float value) {
    ...
    public AnimationBuilder leftMargin(float... margin) {
        return custom(new AnimationListener.Update() {
            @Override
            public void update(View view, float value) {
                ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    public AnimationBuilder rightMargin(float... margin) {
        return custom(new AnimationListener.Update() {
            @Override
            public void update(View view, float value) {
                ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    public AnimationBuilder bottomMargin(float... margin) {
        return custom(new AnimationListener.Update() {
            @Override
            public void update(View view, float value) {
                ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
     ...
     * @return the animation builder
     */
    public AnimationBuilder withAnim(View... views) {
        return anim.addAnimationBuilder(views);
    }
    ...
    /**
     * OnStartListener delay view animator.
     *
     ...
     * @return the animation builder
     */
    public AnimationBuilder repeatMode(@Anim.RepeatMode int repeatMode) {
     ...
     *
     * @param onStartListenerListener the start listener
     * @return the animation builder
     */
    public AnimationBuilder onStart(AnimationListener.OnStartListener onStartListenerListener) {
        anim.onStart(onStartListenerListener);
        return this;
    }
     ...
     *
     * @param onStopListenerListener the stop listener
     * @return the animation builder
     */
    public AnimationBuilder onStop(AnimationListener.OnStopListener onStopListenerListener) {
        anim.onStop(onStopListenerListener);
        return this;
    }
    ...
    public Anim accelerate() {
        return anim.interpolator(new AccelerateInterpolator());
    }

    public Anim descelerate() {
        return anim.interpolator(new DecelerateInterpolator());
    }
    ...
    public AnimationBuilder textSize(float... textSize) {
        return property("textSize", textSize);
    }
